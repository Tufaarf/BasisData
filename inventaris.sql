...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2023 at 08:57 AM
...
CREATE TABLE `inventaris` (
  ...
  `tanggal_register` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_ibfk_1` FOREIGN KEY (`id_pegwai`) REFERENCES `pegawai` (`id_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;
